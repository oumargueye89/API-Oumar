...
"""
Construit un column_transformer personnalisable dont les paramètres peuvent être optimisés dans un GridSearchCV
CATÉGORIQUE : trois stratégies différentes pour 3 types de
...
class CustTransformer(BaseEstimator):
    ...
    def fit(self, X, y=None):
        # Dictionnaire pour traduire les stratégies
